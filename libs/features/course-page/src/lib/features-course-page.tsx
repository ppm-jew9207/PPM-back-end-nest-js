...
export const FeaturesCoursePage = (props: {
  ...
  const { onGetStartedClick, onRemoveFromCourseClick } = useCourses(
  ...
  useEffect(() => {
    if (!loading && profile?.coursesIds?.includes(course?._id)) {
      ...
      <div className="lessons">
        <SharedCourseInfo
          ...
          getStartedButtonText={
            courseStarted ? 'Leave the Course' : 'Start the Course'
          }
        />
        <SharedCourseDetails
